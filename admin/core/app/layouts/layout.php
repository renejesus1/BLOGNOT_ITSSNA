...
<html>
  <head>
    <meta charset="UTF-8">
    <title>TEC-AJALPAN | Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>TEC-AJALPAN</b></span>
        </a>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2024 <a href="https://www.itssna.edu.mx/" target="_blank">ITSSNA</a></strong>
      </footer>
      <?php else:?>
...
<div class="login-box">
      <div class="login-logo">
        <a href="./"><b>INICIO SESION PARA ADMINISTRADOR</b></a>
      </div><!-- /.login-logo -->
