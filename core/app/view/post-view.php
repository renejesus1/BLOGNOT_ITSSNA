...
<div class="container">
<div class="row">
<div class="col-md-12" style="text-align: center; background-color: #808080; padding: 20px;" > 
<h1><?php echo $jb->title; ?></h1>
    <?php if($jb->image!=""):?>
      <img src="admin/uploads/<?php echo $jb->image; ?>" class="img-responsive" style="max-width: 50%; height: 50%; margin: 0 auto;" > 
    <?php endif; ?>
...
<input type="hidden" name="post_id" value="<?php echo $jb->id; ?>">
  <div class="form-group" style="background-color: #808080; padding: 10px; border-radius: 5px;">
